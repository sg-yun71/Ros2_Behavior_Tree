...
static const _PosError_type_support_symbol_names_t _PosError_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_behavior_tree_msgs, msg, PosError)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_behavior_tree_msgs, msg, PosError)),
  }
};
...
{
  return &::my_behavior_tree_msgs::msg::rosidl_typesupport_cpp::PosError_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_behavior_tree_msgs, msg, PosError)() {
  return get_message_type_support_handle<my_behavior_tree_msgs::msg::PosError>();
}
